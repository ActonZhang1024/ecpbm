...
public class ProductInfoController {
    ...
    public Map<String, Object> list(Integer page, Integer rows, ProductInfo productInfo){
        ...
        //获取满足条件的商品总数
        Integer totalCount = productInfoService.count(params);
        //获取满足条件的商品列表
        final List<ProductInfo> productInfos = productInfoService.findProductInfo(productInfo, pager);
        //创建result对象，保存查询结果数据
