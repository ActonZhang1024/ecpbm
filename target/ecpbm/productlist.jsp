				...
				<table cellpadding="5">
					...
					<tr>
						...
						<td><input class="easyui-textbox" type="text" id="brand"
							name="brand" data-options="required:true"/></td>
					</tr>
					<tr>
						<td>商品数量:</td>
						<td><input class="easyui-textbox" type="text" id="num"
							name="num" data-options="required:true"/></td>
					</tr>
					<tr>
						<td>商品价格:</td>
					...
					<tr>
						...
						<td><input class="easyui-filebox" id="file" name="file"
							style="width: 200px" value="选择图片"/></td>
					</tr>
				</table>
			</form>
	...
	<script type="text/javascript">
		$(function() {
			$('#dg_productinfo').datagrid({
				...
				url : '${pageContext.request.contextPath}/productinfo/list', //为datagrid设置数据源
